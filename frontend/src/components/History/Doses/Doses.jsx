...
const Doses = ({ drug }) => {
    ...
    const dose = [1, 2, 3, 4].map((item, key) => {
        ...
        return <Box key={key} value={item} className='doses__items' component="div" sx={{ border: '2px solid black' }}>
                <Typography key={key} className='doses__item' sx={{fontSize:'10px'}} variant="subtitle2" component="div">
           {time}
           </Typography>
                <Typography className='doses__item' sx={{fontSize:'10px'}} variant="subtitle2" component="div">
                {drug.medication}
                </Typography> 
                <Typography className='doses__item' sx={{fontSize:'10px'}} variant="subtitle2" component="div">
            ...
            <Button sx={{fontSize: '9px'}} className='doses__description' variant="text">Dodaj</Button>
            <Checkbox
    ...
    return (
        <Box className='doses' component="div" sx={{ p: 2, border: '2px solid black' }}>
            <Box className='doses__header' component="div" sx={{ border: '2px solid black' }}>
                {titlesArray}           
            </Box>
            <Box>{dose}</Box>
